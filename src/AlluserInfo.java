...
public class AlluserInfo extends javax.swing.JFrame {
    ...
    private static AlluserInfo ref=null;
    private AlluserInfo() 
    {
            ...
            tabel.getColumn("USERNAME").setCellRenderer(alignment);
            tabel.getColumn("PASSWORD").setCellRenderer(alignment);
            ...
            try
            {
              user=Database.fetchallUser();
              DefaultTableModel model=(DefaultTableModel)tabel.getModel();
              
              for(User val:user)
              {
                model.addRow(new Object[]{new Integer(srno++),val.getUsername(),val.getPassword()});
              }
    ...
    public static AlluserInfo getObj()
    {
        if(ref==null)
        {
            ref=new AlluserInfo();
