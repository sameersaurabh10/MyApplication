...
public class UpdateStock extends javax.swing.JFrame {
     ...
     */
    private  static UpdateStock ref=null;
...
*/
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Medicine Name", "Box", "Pkg / Box", "Tablet / Pkg", "DeadLine", "Cost", "MRP / Tablet", "Date"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Object.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class
            };
        ...
        cmdupdate.setFont(new java.awt.Font("Benguiat Bk BT", 1, 14)); // NOI18N
        ...
        jPanel1.add(cmdupdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 330, 90, 30));
            ...
            try
            {
                ...
                for(int i=0;i<m.size();i++)
                {
                    if(text[0].equals(m.get(i).getMname()))
                    {
                        ...
                        box,pkg,tabletp,dl,m.get(i).getCost(),
                        m.get(i).getMrp(),m.get(i).getDate()});
    ...
    private void cmdupdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdupdateActionPerformed
        try 
        {
            ...
            String sql="update medicine set Box=?,package=?,totalquantity=?,deadline=?,cost=?,mrp=?,date=? where mname=?";
            PreparedStatement ps=cn.prepareStatement(sql);
           
            box=box+(int)table.getValueAt(0, 1);
            pkg=pkg+(int)table.getValueAt(0, 2);
            tq=tq+box*pkg+(int)table.getValueAt(0, 3);
            
            int dl=(int)table.getValueAt(0, 4);
            double cost=Double.parseDouble(table.getValueAt(0, 5).toString());
            double mrp=Double.parseDouble(table.getValueAt(0, 6).toString());
            String date=table.getValueAt(0, 7)+"";
            String mname=table.getValueAt(0, 0)+"";
            //JOptionPane.showMessageDialog(this, mname);
